const I18N = {
  en: {
    ...
    intro:
      "WASL is a simple system for companies. We are looking for marketers to join our team. You will earn commission.",
    pill1: "Commission",
    pill2: "Join our market team",
    pill3: "One-page application",
    formTitle: "Apply to join",
    formLead: "Tell us a little about yourself. Keep it simple.",
    name: "Full name",
    age: "Age",
    gender: "Gender",
    male: "Male",
  ...
  ar: {
    ...
    title: "كن مسوّق وصل",
    intro:
      "وصل نظام بسيط للشركات. نبحث عن مسوقين للانضمام إلى فريقنا. ستحصل على عمولة.",
    pill1: "عمولة",
    pill2: "انضم لفريق السوق",
    pill3: "طلب في صفحة واحدة",
    formTitle: "قدّم للانضمام",
    formLead: "أخبرنا عنك باختصار. بدون تفاصيل طويلة.",
    name: "الاسم الكامل",
    age: "العمر",
    gender: "الجنس",
    male: "ذكر",
